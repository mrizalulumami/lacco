   ...
   <div class="app-sidebar__overlay" data-toggle="sidebar">
    <aside class="app-sidebar">
      ...
      <ul class="app-menu" style="font-size: 12px">
        ...
        <li>
          <a class="app-menu__item fo-col" href="dashboard-member.html"><span class="app-menu__label">Member</span></a>
        </li>
        <li class="treeview"><a class="app-menu__item fo-col" href="#" data-toggle="treeview"><span
              class="app-menu__label">Member Registration</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li>
              <a class="treeview-item" href="dashboard-Non-verified.html">Non-Verified</a>
              <a class="treeview-item" href="dashboard-Verified.html">Verified</a>
            </li>
          </ul>
        </li>
        <li>
          <a class="app-menu__item fo-col" href="dashboard-Program_history.html"><span class="app-menu__label">Program
              History</span></a>
        </li>
        <!--  -->
        ...
        <li>
          <a class="app-menu__item fo-col" href="dashboard-Package.html"><span class="app-menu__label">Package</span></a>
        </li>
        <li>
          <a class="app-menu__item fo-col" href="dashboard-Program.html"><span class="app-menu__label">Program</span></a>
        </li>
        <li>
          <a class="app-menu__item fo-col" href="dashboard-Camp.html"><span class="app-menu__label">Camp</span></a>
        </li>
        <li>
          <a class="app-menu__item fo-col" href="dashboard-Tutor.html"><span class="app-menu__label">Tutor</span></a>
        </li>
        <li>
          <a class="app-menu__item fo-col" href="dashboard-User.html"><span class="app-menu__label">User</span></a>
        </li>
        <!--  -->
